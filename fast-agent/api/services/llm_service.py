        ...
        try:
            ...
            if tool_calls and tool_executor:
                ...
                for m in current_messages:
                    if isinstance(m, dict) and m.get("role") and ("content" in m or "tool_calls" in m):
                        ...
                        if msg_to_add.get("role") == "tool" and "tool_call_id" in msg_to_add and "content" in msg_to_add:
                    ...
                    elif not isinstance(m, dict) and hasattr(m, 'role'): 
                        msg_to_add = {"role": m.role}
